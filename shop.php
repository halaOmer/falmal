        ...
        <div class="container">
            <div class="row">
                ...
                <!--        
                       <div class="filter-sidebar-left" style="float:right;">
                            ...
                            <div class="list-group list-group-collapse list-group-sm list-group-tree" id="list-group-men" data-children=".sub-men" align=right >
                                <div class="list-group-collapse sub-men" id="7">
                                    <a class="list-group-item list-group-item-action" href="#sub-men1" data-toggle="collapse" aria-expanded="true" aria-controls="sub-men1">الملابس والمستلزمات الشخصية  <small class="text-muted"></small>
								</a>
                                    <div class="collapse show" id="sub-men1" data-parent="#list-group-men" style="text-align=right;">
                                        <div class="list-group">
                                            
                                            <a href="mclothes.php" class="list-group-item list-group-item-action">ملابس رجالية <small class="text-muted"></small></a>
                                            <a href="wclothes.php" class="list-group-item list-group-item-action active">ملابس نسائية<small class="text-muted"></small></a>
                                            <a href="tobs.php" class="list-group-item list-group-item-action active">تياب سودانية <small class="text-muted"></small></a>
                                            <a href="childcl.php" class="list-group-item list-group-item-action">ملابس أطفال <small class="text-muted"></small></a>
                                            <a href="mneeds.php" class="list-group-item list-group-item-action"> مستلزمات رجالية  <small class="text-muted"></small></a>
                                            <a href="wneeds.php" class="list-group-item list-group-item-action">مستلزمات نسائية  <small class="text-muted"></small></a>
                                            <a href="childneed.php" class="list-group-item list-group-item-action">مستلزمات أطفال  <small class="text-muted"></small></a> 
                                            <a href="pags.php" class="list-group-item list-group-item-action">حقائب وأحذية رجالية  <small class="text-muted"></small></a>
                                            <a href="pagsns.php" class="list-group-item list-group-item-action"> حقائب وأحذية نسائية <small class="text-muted"></small></a>
                                            <a href="acc.php" class="list-group-item list-group-item-action">اكسسوارات <small class="text-muted"></small></a>
                                        </div>
                                    </div>
                                </div>
                                <div class="list-group-collapse sub-men" id="4" >
                                    <a class="list-group-item list-group-item-action" href="#sub-men2" data-toggle="collapse" aria-expanded="false" aria-controls="sub-men2"> مستلزمات المنزل  
								<small class="text-muted"></small>
								</a>
                                    <div class="collapse" id="sub-men2" data-parent="#list-group-men">
                                        <div class="list-group">
                                            <a href="decor.php" class="list-group-item list-group-item-action" >  ديكور ومفارش  <small class="text-muted"> </small></a>
                                            <a href="dishes.php" class="list-group-item list-group-item-action">  أواني مطبخ  <small class="text-muted"> </small></a>
                                            <a href="furniture.php" class="list-group-item list-group-item-action">  أثاثات  <small class="text-muted"> </small></a>
                                            <a href="house.php" class="list-group-item list-group-item-action">  مستلزمات منزل أخرى  <small class="text-muted"> </small></a>
                                ...
                                <div class="list-group-collapse sub-men">
                                    <a class="list-group-item list-group-item-action" href="#sub-men3" data-toggle="collapse" aria-expanded="false" aria-controls="sub-men2">  أجهزة كهربائية وإلكترونية ، ألعاب ، كروت  
								<small class="text-muted"></small>
								</a>
                                    <div class="collapse" id="sub-men3" data-parent="#list-group-men">
                                        <div class="list-group">
                                            <a href="phone.php" class="list-group-item list-group-item-action">   هواتف  <small class="text-muted"> </small></a>
                                            <a href="computers.php" class="list-group-item list-group-item-action">  حواسيب   <small class="text-muted"> </small></a>
                                            <a href="games.php" class="list-group-item list-group-item-action">  شحن كروت ألعاب   <small class="text-muted"> </small></a>
                                            <a href="carts.php" class="list-group-item list-group-item-action">  كروت رقمية   <small class="text-muted"> </small></a>
                                            <a href="edv.php" class="list-group-item list-group-item-action"> أدوات كهربائية <small class="text-muted"> </small></a>
                       ...
                       <!--         <div  id="6">
                                <a href="handmade.php" class="list-group-item list-group-item-action">أشغال يدوية <small class="text-muted"></small></a>
                                <a href="cars.php" class="list-group-item list-group-item-action"> سيارات<small class="text-muted"></small></a>
                                <a href="builds.php" class="list-group-item list-group-item-action"> عقارات <small class="text-muted"></small></a>
                                <a href="foods.php" class="list-group-item list-group-item-action"> مواد غذائية <small class="text-muted"></small></a>
                            </div> </div>
                        </div>
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                     <div class="type-lb">
                                                        <p class="sale"> متجر رقم <?php echo $row["name"]; ?> </p>
                                                    </div>
                          ...
                          <div  class="d-block w-100 img-fluid" >         <?php // echo "<img src='images/".$row["image3"]."' width= 50px />"; ?> </div>
                                            ...
                                            <div class="col-sm-6 col-md-6 col-lg-8 col-xl-8">
                                                <div class="why-text full-width">
                                                    ...
                                                    ج س</h5>
                                                    <h5 style="text-align:right;">الكمية المتوفرة   &nbsp;&nbsp; <?php  if($row["quantity"]<0)
                                                    { echo 0 ; } else echo $row["quantity"];' ' ?>   
                                                     </h5>

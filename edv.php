...
<?php 
 ...
 $query = "select *from products where category='edv'";
 ...
 $query = "select *from products where category='edv' LIMIT " . $page_first_result . ',' . $results_per_page; 
            ...
            <div class="row">
                <div class="col-xl-3 col-lg-3 col-sm-12 col-xs-12 sidebar-shop-left">
                    <div class="product-categori">
                        ...
                        <?php       $sql = "select *from products where  category='edv' order by id DESC LIMIT " . $page_first_result . ',' . $results_per_page;
...
<!--<input type="text" placeholder="Type the name here" name="search">&nbsp;
 <input type="submit" value="إبحث" name="btn"  >-->
		...
		$query = "select *from products where category='edv' order by id DESC LIMIT " . $page_first_result . ',' . $results_per_page; 
		$result = mysqli_query($db, $query);
                                        ...
                                        <div class="col-sm-6 col-md-6 col-lg-4 col-xl-4">
                                            <div class="products-single fix">
                                                <div class="box-img-hover">
                                                     <div class="type-lb">
                                                        <p class="sale">  <?php echo $row["name"]; ?> رقم المتجر</p>
                                                    </div>
													<div class="img-fluid">
                                                   <?php
...
echo '<a href = "edv.php?page=' . $page . '">' . $page . ' </a>';
 }  
